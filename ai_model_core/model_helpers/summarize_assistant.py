...
class SummarizationAssistant:
    ...
    async def summarize_stuff(self, state: OverallState) -> dict:
        ...
        chain = self.stuff_prompt | self.model
    ...
    async def generate_map_summary(self, state: SummaryState) -> dict:
        ...
        chain = self.map_prompt | self.model
    ...
    async def reduce_summaries(self, state: OverallState) -> dict:
        ...
        chain = self.map_reduce_prompt | self.model
    ...
    async def refine_summary(self, state: SummaryState) -> dict:
        ...
        chain = self.refine_prompt | self.model
    ...
    async def summarize(self, content: Union[str, List[str]], method: str = "map_reduce", language: str = "english") -> str:
        ...
        result = await self.graph_runnable.ainvoke({"chunks": chunks, "method": method, "language": language})
